...
function Booking() {
  ...
  const tax = (  parseFloat(totalofpax || 0) + parseFloat(sumData.tourAmount || 0)) * 0.1;
    ...
    <div align="center">
      <div id="divToPrint" style={{ padding: "20px" }}>
        ...
        <div>
         ...
         {/* <h6 style={{ marginLeft: '700px' }}>total :{totalofpax}</h6> */}
         <h6 >______________________________________________________________________________________________________________________________________________________________________________________</h6>
        </div>
