...
public class DateMasterController {
    ...
    @GetMapping("/subcategories/{noOfDays}")
    public List<SubCategoryMaster> getSubCategoriesByNoOfDays(@PathVariable Integer noOfDays) {
        return dateMasterService.getSubCategoriesByNoOfDays(noOfDays);
    }
    @GetMapping("/datemasters/subcategory/{subCatId}")
    public List<DateMaster> getDateMastersBySubCategoryId(@PathVariable Integer subCatId) {
        return dateMasterService.getDateMastersBySubCategoryId(subCatId);
    }
}
