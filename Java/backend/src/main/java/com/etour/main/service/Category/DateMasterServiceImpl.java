...
public class DateMasterServiceImpl implements DateMasterService {
	...
	public List<SubCategoryMaster> getSubCategoriesByNoOfDays(Integer noOfDays) {
        return dateMasterRepository.findSubCategoriesByNoOfDays(noOfDays);
    }
	
	public List<DateMaster> getDateMastersBySubCategoryId(Integer subCatId) {
        return dateMasterRepository.findBySubCategoryId(subCatId);
    }
}
